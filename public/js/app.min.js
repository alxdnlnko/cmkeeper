...
angular.module('CMKeeper', ['ui.router']);
...
},{"./../../bower_components/angular-ui-router/release/angular-ui-router.js":1,"./../../bower_components/angular/angular.js":2,"./loginctrl":4,"./models":6,"./notesctrl":8,"./routes":9,"./signupctrl":10}],4:[function(require,module,exports){
angular.module('CMKeeper').controller('LoginCtrl', [function() {}]);
...
CategoryFabric = function($http) {
  var Category;
  Category = function(obj) {
    var _ref, _ref1;
    this.id = (_ref = obj != null ? obj.id : void 0) != null ? _ref : null;
    this.name = (_ref1 = obj != null ? obj.name : void 0) != null ? _ref1 : '';
    return this;
  };
  Category.prototype.$save = function() {};
  Category.$objects = {
    $all: function(cb) {
      return $http.get('/api/category').success(function(data, status) {
        var obj;
        return typeof cb === "function" ? cb(null, (function() {
          var _i, _len, _results;
          _results = [];
          for (_i = 0, _len = data.length; _i < _len; _i++) {
            obj = data[_i];
            _results.push(new Category(obj));
          }
          return _results;
        })()) : void 0;
      });
...
angular.module('CMKeeper').factory('Category', ['$http', CategoryFabric]);
...
},{"./category":5,"./note":7}],7:[function(require,module,exports){
var NoteFabric;

NoteFabric = function($http) {
  var Note;
  Note = function(obj) {
    var _ref, _ref1, _ref2, _ref3;
    this.id = (_ref = obj != null ? obj.id : void 0) != null ? _ref : null;
    this.name = (_ref1 = obj != null ? obj.name : void 0) != null ? _ref1 : '';
    this.content = (_ref2 = obj != null ? obj.content : void 0) != null ? _ref2 : '';
    this.archived = (_ref3 = obj != null ? obj.archived : void 0) != null ? _ref3 : false;
    return this;
  };
  Note.prototype.$save = function() {};
  Note.$objects = {
    $all: function(categoryId, cb) {
      return $http.get("/api/category/" + this.categoryId + "/note").success(function(data, status) {
        var obj;
        return typeof cb === "function" ? cb(null, (function() {
          var _i, _len, _results;
          _results = [];
...
angular.module('CMKeeper').factory('Note', ['$http', NoteFabric]);
...
PageCtrl = function($scope, $state, $stateParams, $window, Storage) {
  var stateChanged;
  $scope.storage = Storage;
  $scope.showNonArcihved = true;
  $scope.showArcihved = true;
  $scope.toggleNonArchived = function() {
    return $scope.showNonArcihved = !$scope.showNonArcihved;
  };
  $scope.toggleArchived = function() {
    return $scope.showArcihved = !$scope.showArcihved;
  };
  $scope.startEditing = function(note) {
    return Storage.startEditing();
  };
  $scope.saveEditing = function() {
    return Storage.saveEditing();
  };
  $scope.cancelEditing = function() {
    return Storage.cancelEditing();
  };
  ...
  $scope.addCategory = function() {
    return Storage.addCategory();
  };
  $scope.saveCategory = function() {
    return Storage.saveNewCategory();
  };
  $scope.filterNonArchived = function(note) {
    return !note.archived;
  };
  $scope.filterArchived = function(note) {
    return note.archived;
  };
  stateChanged = function() {
    switch ($state.current.name) {
      case 'notes':
        break;
      case 'notes.category':
        Storage.selectCategory($stateParams.categoryId, function(err) {
          if (err) {
      ...
      case 'notes.note':
        Storage.selectCategory($stateParams.categoryId, function(err) {
          ...
          return Storage.selectNote($stateParams.noteId, function(err) {
            if (err) {
              return $window.location.hash = "/" + $stateParams.categoryId;
            }
          });
        });
    }
  ...
  $scope.$on('newNoteSaved', function(event, note) {
    if (note === Storage.currentNote) {
      return $window.location.hash = "/" + Storage.currentCategory.id + "/" + note.id;
    }
  });
  return $scope.$on('$stateChangeSuccess', stateChanged);
};

angular.module('CMKeeper').controller('NotesCtrl', ['$scope', '$state', '$stateParams', '$window', 'Storage', PageCtrl]);



},{"./storage":11}],9:[function(require,module,exports){
var configureRoutes;

configureRoutes = function($stateProvider, $urlRouterProvider) {
  $urlRouterProvider.rule(function($injector, $location) {
    var path;
    path = $location.url();
...
angular.module('CMKeeper').config(['$stateProvider', '$urlRouterProvider', configureRoutes]);



},{}],10:[function(require,module,exports){
angular.module('CMKeeper').controller('SignupCtrl', [function() {}]);
...
Storage = function(Note, Category, $rootScope) {
  this.categories = [];
  ...
  this.loadCategories = function() {
    ...
    $timeout(function() {
      ...
      return deferred.resolve(['Category1', 'Category2']);
    }, 2000);
    return deferred.promise;
  };
  this.loadNotes = function(cb) {
    if (!this.currentCategory) {
      return typeof cb === "function" ? cb(new Error('No category')) : void 0;
    }
    this.currentCategory;
    return Note.$objects.$all(this.currentCategory.id, (function(_this) {
  ...
  this.selectCategory = function(id, cb) {
    var cat, category, _ref;
    if (((_ref = this.currentCategory) != null ? _ref.id : void 0) === id) {
      return typeof cb === "function" ? cb() : void 0;
    }
    category = ((function() {
    ...
    this.currentNote = null;
    return this.loadNotes(cb);
  };
  this.selectNote = function(id, cb) {
    var note;
    note = ((function() {
    ...
    if (!note) {
      return typeof cb === "function" ? cb(new Error('No note')) : void 0;
    }
    this.currentNote = note;
    return typeof cb === "function" ? cb() : void 0;
  };
  this.addCategory = function() {
    return this.newCategory = new Category();
  };
  ...
  this.startEditing = function() {
    var key, obj, val, _ref;
    if (!this.currentNote) {
      return;
    }
    obj = {};
    _ref = this.currentNote;
    for (key in _ref) {
      val = _ref[key];
      if (key[0] !== '$') {
        obj[key] = val;
  ...
  this.saveEditing = function() {
    ...
    if (!this.currentNote) {
      this.currentNote = new Category(this.editedNote);
      this.notes.unshift(this.currentNote);
      (function(note) {
        return note.$save().then(function(data) {
          console.log("" + note.id + " added!");
          return $rootScope.$broadcast('newNoteSaved', note);
        }, function(data) {
          return console.log("Can't save " + note.id + " note");
        });
      })(this.currentNote);
    } else {
      _ref = this.editedNote;
      for (key in _ref) {
        val = _ref[key];
        this.currentNote[key] = val;
      }
      (function(note) {
        return note.$update().then(function(data) {
          return console.log("" + note.id + " saved!");
        }, function(data) {
          return console.log("Can't save " + note.id + " note");
        });
      })(this.currentNote);
    }
    return this.editedNote = null;
  };
...
angular.module('CMKeeper').service('Storage', ['Note', 'Category', '$rootScope', '$q', '$timeout', Storage]);
